...
\include{part02/correlation}
\include{part02/regression}
\include{part02/multipleRegression}
\include{part02/logRegression}
\include{part02/checking}

\part{Comparisons Among\\Multiple Samples}
\include{part03/tTools}
\include{part03/tAlternatives}
\include{part03/anova}
\include{part03/multifactor}
\include{part03/multifactorRep}
