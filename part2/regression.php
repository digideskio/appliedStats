<?php
  $title = "Simple Linear Regression | Applied Statistics";
  require_once("../header.php");
?>
    <h1>07 &mdash; Simple Linear Regression</h1>
